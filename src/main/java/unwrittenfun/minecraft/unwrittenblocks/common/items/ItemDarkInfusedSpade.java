 ...
 * Created: 04/11/2014.
 */
public class ItemDarkInfusedSpade extends ItemSpade {
    protected ItemDarkInfusedSpade(String key) {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List lines, boolean bool) {
        ...
        lines.add(StatCollector.translateToLocal("unwrittenblocks.text.infusedFrom") + " " + StatCollector.translateToLocal("unwrittenblocks.text.diamondSpade"));
    }
}
