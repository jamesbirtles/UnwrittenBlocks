...
public class ItemStorageBall extends ItemUB {
  public static final String[] BALL_TYPES = new String[] {"Cobblestone", "MossyCobblestone", "Netherrack", "OakWood"};
  private IIcon[] icons;
  ...
  @SuppressWarnings("unchecked") @Override public void getSubItems(Item item, CreativeTabs stack, List list) {
