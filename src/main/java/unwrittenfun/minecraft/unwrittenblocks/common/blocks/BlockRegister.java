...
public class BlockRegister {
  ...
  public static BlockRefulgentWall refulgentWall;
  public static BlockRefulgentWall refulgentBrick;
  ...
  public static void registerBlocks() {
    ...
    refulgentWall = new BlockRefulgentWall(REFULGENT_WALL_KEY);
    refulgentBrick = new BlockRefulgentWall(REFULGENT_BRICK_KEY);
